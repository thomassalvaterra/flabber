...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const move = (time: number) => {
      ...
      previousTime = time;
      if (loopDistance > 0) {
        offset = (offset + elapsed * .085) % loopDistance;
    ...
    <main>
      ...
      <section className="teaser" id="manifesto">
        ...
        <div className="manifesto-stage">
          <div className="manifesto-heading">
            ...
            <p className="manifesto-note reveal">Costruiamo identità riconoscibili, contenuti che parlano e strategie capaci di lasciare il segno.</p>
          </div>
      ...
      <section className="studio section" id="studio">
        ...
        <div className="studio-gallery reveal" aria-label="Flabber Studio dietro le quinte">
          <figure><img src="/studio/studio-production.webp" alt="Team Flabber al lavoro durante una produzione fotografica in studio" loading="lazy" decoding="async" /><figcaption><span>01</span>Produzione sul set</figcaption></figure>
          <figure><img src="/studio/studio-industry.webp" alt="Videomaker Flabber durante una produzione in un laboratorio industriale" loading="lazy" decoding="async" /><figcaption><span>02</span>Produzione industriale</figcaption></figure>
      ...
      <section className="contact" id="contatti">
        ...
        <footer><a className="brand footer-brand" href="#top" aria-label="Flabber Studio - torna all'inizio"><span className="brand-lockup"><img src="/branding/flabber-lockup.png" alt="Flabber Studio" /></span></a><p>Digital Agency · Italy<br />© 2026 Flabber Studio</p></footer>
      </section>
    </main>
  );
}
